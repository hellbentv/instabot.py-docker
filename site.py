...
print "Logging in as %s" % os.environ['USERNAME']
bot = InstaBot(login=os.environ['USERNAME'], password=os.environ['PASSWORD'],
               like_per_day=1000,
               comments_per_day=50,
               tag_list=['sunset', 'sunsets', 'sunrise', 'travel ','instatravel','travelgram','tourist','tourism','vacation','getaway','traveling','trip','vacation','getaway','ilovetravel','jetsetter','visit','view','traveling','visiting','instago','holiday','instatraveling','igtravel','travelling','travelpics','passportready','travelblogger','instavacation','wanderlust'],
